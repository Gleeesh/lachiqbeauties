        ...
        <div className="font-sans text-gray-800 bg-pink-200">
          ...
          {menuOpen && (
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-64 bg-white shadow-lg z-55 p-6 flex flex-col space-y-6"
            >
              <button
          ...
          {/* Fixed Social Icons */}
          <div className="fixed top-1/2 right-2 z-60 flex flex-col items-center -translate-y-1/2">
            <a
              href="https://wa.me/254710101118"
              target="_blank"
              rel="noopener noreferrer"
